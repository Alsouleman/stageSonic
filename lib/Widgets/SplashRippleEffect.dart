...
class SplashRippleEffect extends StatefulWidget {
  const SplashRippleEffect({Key? key}) : super(key: key);

  @override
  _SplashRippleEffectState createState() => _SplashRippleEffectState();
}

class _SplashRippleEffectState extends State<SplashRippleEffect>
